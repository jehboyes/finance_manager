...
class input_nonp_other(Base):
    __tablename__ = 'input_non_other'
...
class input_nonp_internal(Base):
    ...
    costc = Column(CHAR(6), ForeignKey("cost_centre.costc"), nullable=True)
    amount = Column(FDec, nullable=True)
