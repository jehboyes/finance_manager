...
class f_set(Base):
    ...
    acad_year : int
        The calendar year in which the academic year 
        commences (e.g. 2020 for the 20/21 year)
    costc : str
        The cost centre ID. 
    set_cat_id : str
        Set category ID. 
...
class hfi_bursary(Base):
    ...
    ----------
    acad_year : int
        The calendar year that the academic year commences. 
    set_cat_id : str
...
class pension(Base):
    ...
    A pension scheme, relevant because of employer's contributions. Exists 
    purely as a foregin key reference for  
