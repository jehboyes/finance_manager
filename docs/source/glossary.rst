...
.. glossary::
    ...
    On-costs
        ...
        the applciation of holiday accrual, or the :term:`Teaching Uplift`.
    ...
    Academic Year
        ...
        Throughout this project, academic year refers to a calendar year in which an academic year begins. It crops in several tables and views and is **always** a four-digit integer. For example, 
        the 'value' of the academic year for the 20/21 academic year would be 2020. 

        Enforcing this not only assures consistency throughout the project, but also allows for arithmetic with years.      
